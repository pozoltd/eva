...
class Init implements ControllerProviderInterface
{
    ...
    public function data(Application $app, Request $request)
    {
        ...
        if (!$orm) {
            ...
            $orm->tags = "[\"$tag->id\"]";
            $orm->items = '[{"widget":"0","id":"text","title":"Text:","sql":""},{"widget":"1","id":"textarea","title":"Textarea:","sql":""},{"widget":"2","id":"assetPicker","title":"Asset picker:","sql":""},{"widget":"3","id":"assetFolderPicker","title":"Asset folder picker:","sql":""},{"widget":"4","id":"checkbox","title":"Check box:","sql":""},{"widget":"5","id":"wysiwyg","title":"Wysiwyg:","sql":""},{"widget":"6","id":"date","title":"Date:","sql":""},{"widget":"7","id":"dateTime","title":"Date time:","sql":""},{"widget":"8","id":"time","title":"Time:","sql":""},{"widget":"9","id":"choice","title":"Choice:","sql":"SELECT id AS `key`, title AS value FROM __contents WHERE __modelClass = \'Page\' ORDER BY __rank\n"},{"widget":"10","id":"choiceMultiJson","title":"Choice multi json:","sql":"SELECT id AS `key`, title AS value FROM __contents WHERE __modelClass = \'Page\' ORDER BY __rank\n"},{"widget":"11","id":"placeholder","title":"Place holder:","sql":""}]';
            $orm->save();
        }
